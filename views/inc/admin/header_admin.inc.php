...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet"
		      type="text/css"
					href="styles/stylesheet_kitchen.css"
					media="screen and (min-width: 768px)"
		/>
  	...
  	<script>
  		...
  		function handle_input(){
  			$('#search_form input').keyup(function(){
  				var data = $(this).val();
  				$.get('search.php', data, function(response){
	...
	<div id="bg_header"><!--color across the view port--></div>
	  <div id="wrapper">
	    ...
	    <!--Nav menu it will have 5 links/buttons-->
			  <?php include '../views/inc/admin/admin_nav.inc.php';?>
			</header>


			<div id="content">
        <?php if(!empty($flash_message)) echo "<h2>Message!!: $flash_message</h2><br/><h3>Thanks for registering!!</h3>"; ?>
			  <div id="order_online"><a href="?page=home" title="home">HOME</a>
        </div>
